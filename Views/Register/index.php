    ...
    <div class="container vh-100 position-relative">
        <div class="row justify-content-center">
            <div class="col-6 text-center bg-white rounded-lg shadow-lg position-absolute center">
                <h2 class="mt-4 mb-5">Create an account!</h2>
                <form action="/register" method="post">
                    ...
                    <div class="pt-5 w-50 mx-auto">
                        <a href="/login" class="text-decoration-none text-secondary mt-5 font-weight-bold ">
                            <p>Already have an account?</p>
                        </a>
                    </div>
                    <button type="submit" id="registerSubmit" name="registerSubmit" class="btn btn-outline-secondary px-4 my-5">Register</button>
                </form>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    function validateForm() {
        ...
        document.getElementById("registerSubmit").disabled = !cansubmit;
        if (!cansubmit)
